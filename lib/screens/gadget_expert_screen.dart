...
class GadgetExpertScreen extends StatefulWidget {
  final String vehicleID;
  GadgetExpertScreen({@required this.vehicleID});
  @override
  _GadgetExpertScreenState createState() => _GadgetExpertScreenState();
}

class _GadgetExpertScreenState extends State<GadgetExpertScreen> {
  @override
          ...
          children: [
            ...
            Flexible(
              ...
              child: Container(
                ...
                child: WebView(
                  initialUrl: 'https://expert.gadgetdoc.tech/',
