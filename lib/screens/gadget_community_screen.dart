...
class GadgetCommunityScreen extends StatefulWidget {
  final String vehicleID;
  GadgetCommunityScreen({@required this.vehicleID});
  @override
  _GadgetCommunityScreenState createState() => _GadgetCommunityScreenState();
}

class _GadgetCommunityScreenState extends State<GadgetCommunityScreen> {
  @override
          ...
          children: [
            ...
            Flexible(
              ...
              child: Container(
                ...
                child: WebView(
                  initialUrl: 'https://forum.gadgetdoc.tech',
